...
public final class ChatServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "com.example.grpc.chat.ChatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.chat.ChatMessage,
      com.example.grpc.chat.ChatMessage> getSendMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMessage",
      requestType = com.example.grpc.chat.ChatMessage.class,
      responseType = com.example.grpc.chat.ChatMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<com.example.grpc.chat.ChatMessage,
      com.example.grpc.chat.ChatMessage> getSendMessageMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.chat.ChatMessage, com.example.grpc.chat.ChatMessage> getSendMessageMethod;
      ...
      synchronized (ChatServiceGrpc.class) {
        if ((getSendMessageMethod = ChatServiceGrpc.getSendMessageMethod) == null) {
          ChatServiceGrpc.getSendMessageMethod = getSendMessageMethod =
              io.grpc.MethodDescriptor.<com.example.grpc.chat.ChatMessage, com.example.grpc.chat.ChatMessage>newBuilder()
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.example.grpc.chat.ChatMessage> sendMessage(
        io.grpc.stub.StreamObserver<com.example.grpc.chat.ChatMessage> responseObserver) {
  ...
  public static final class ChatServiceStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.example.grpc.chat.ChatMessage> sendMessage(
        io.grpc.stub.StreamObserver<com.example.grpc.chat.ChatMessage> responseObserver) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
            new MethodHandlers<
              com.example.grpc.chat.ChatMessage,
              com.example.grpc.chat.ChatMessage>(
